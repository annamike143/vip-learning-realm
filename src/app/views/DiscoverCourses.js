...
return (
    <div className="discover-section">
        <div className="container">
                <h2 className="section-title">Discover New Courses</h2>
                <p className="subtitle">Continue your growth and master new skills to elevate your business.</p>
            <div className="courses-grid">
                ...
                {comingSoonCourses.length > 0 && (
                        <div className="section-group coming-soon-section">
                            <h2>Coming Soon</h2>
                            <p className="subtitle">Get ready for the next evolution in your training.</p>
                            <div className="courses-grid">
